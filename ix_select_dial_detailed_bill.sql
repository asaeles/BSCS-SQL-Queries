SELECT   /*+ FIRST_ROWS */
         u.uds_free_unit_part_id, u.free_units_info_part_creator, cu.custcode "Customer Code", dn.dn_num "Dial",
...
--         u.rounded_volume_umcode rou
   ...
   WHERE csc.dn_id = dn.dn_id
     ...
     AND sn.lng_id = NVL(cc.cclanguage, 1)
